-- ================================================================
-- DumpTruckBoss — Complete RLS Fix + Table Creation
-- Run this entire script in Supabase SQL Editor.
-- Safe to re-run: all DROP/CREATE are idempotent.
-- ================================================================
...
-- Columns match lib/workflows.ts (logActivity) and dashboard/page.tsx
-- ================================================================
...
CREATE POLICY "drivers: select" ON drivers FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "drivers: insert" ON drivers FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "drivers: update" ON drivers FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "drivers: delete" ON drivers FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "trucks: select" ON trucks FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "trucks: insert" ON trucks FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "trucks: update" ON trucks FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "trucks: delete" ON trucks FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "loads: select" ON loads FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "loads: insert" ON loads FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "loads: update" ON loads FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "loads: delete" ON loads FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "load_tickets: select" ON load_tickets FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "load_tickets: insert" ON load_tickets FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "load_tickets: update" ON load_tickets FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "load_tickets: delete" ON load_tickets FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "dispatches: select" ON dispatches FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "dispatches: insert" ON dispatches FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "dispatches: update" ON dispatches FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "dispatches: delete" ON dispatches FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "contractors: select" ON contractors FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractors: insert" ON contractors FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractors: update" ON contractors FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractors: delete" ON contractors FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "contractor_tickets: select" ON contractor_tickets FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractor_tickets: insert" ON contractor_tickets FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractor_tickets: update" ON contractor_tickets FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractor_tickets: delete" ON contractor_tickets FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "contractor_ticket_slips: select" ON contractor_ticket_slips FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractor_ticket_slips: insert" ON contractor_ticket_slips FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractor_ticket_slips: update" ON contractor_ticket_slips FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "contractor_ticket_slips: delete" ON contractor_ticket_slips FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "jobs: select" ON jobs FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "client_companies: select" ON client_companies FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "client_companies: insert" ON client_companies FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "client_companies: update" ON client_companies FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "client_companies: delete" ON client_companies FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
-- ================================================================
-- 14. INVOICE_LINE_ITEMS  (no company_id — access via parent invoice)
-- ================================================================
...
CREATE POLICY "received_invoices: select" ON received_invoices FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "received_invoices: insert" ON received_invoices FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "received_invoices: update" ON received_invoices FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "received_invoices: delete" ON received_invoices FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "payments: insert" ON payments FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "payments: update" ON payments FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "driver_payments: select" ON driver_payments FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "driver_payments: insert" ON driver_payments FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "driver_payments: update" ON driver_payments FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "driver_payments: delete" ON driver_payments FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
...
CREATE POLICY "activity_feed: select" ON activity_feed FOR SELECT
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "activity_feed: insert" ON activity_feed FOR INSERT
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "activity_feed: update" ON activity_feed FOR UPDATE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()))
  WITH CHECK (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));
CREATE POLICY "activity_feed: delete" ON activity_feed FOR DELETE
  USING (company_id IN (SELECT id FROM companies WHERE owner_id = auth.uid()));


-- ================================================================
-- 20. TEAM_MEMBERS
-- Owner manages; invited user can read their own row.
-- ================================================================
...
-- ================================================================
-- 21. INVITATIONS
-- Owner manages; invitee can read their pending invite by email.
-- ================================================================
...
-- ================================================================
-- AUDIT: run after applying — should return 0 rows if all covered
-- ================================================================
SELECT t.tablename
FROM pg_tables t
...
-- ================================================================
-- ORPHAN CHECK: auth users with no company row
-- ================================================================
